...
const SOCIAL_ENTRIES: Array = [
	...
	},
	{
		...
		"zone_type": "fire",
		"speaker": "Tamsin Reed",
		"required_units": ["Tamsin Reed", "Liora"],
		"optional_units": ["Branik", "Rufus"],
		"min_participants": 3,
		"max_participants": 4,
		"ambient_behavior_family": "morale_fire",
		"lines": [
			{ "speaker": "Tamsin Reed", "text": "Eat first, worry second. In that order." },
		],
		"once_per_visit": true,
		"radius": 182.0,
	...
	},
	{
		...
		"zone_type": "cook_area",
		"speaker": "Tamsin Reed",
		"required_units": ["Tamsin Reed", "Rufus"],
		"optional_units": ["Branik", "Pell Rowan"],
		"min_participants": 3,
		"max_participants": 4,
		"ambient_behavior_family": "work_detail",
		"lines": [
			{ "speaker": "Tamsin Reed", "text": "Mind the knives, mind the pot, and save the heroic nonsense until after the onions are diced." },
		],
		"once_per_visit": true,
		"radius": 182.0,
		"cluster_radius": 124.0,
	...
	{
		"id": "social_theme_gossip_darian_tariq_bench",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		"zone_type": "bench",
		...
		"preferred_visit_themes": ["gossip"],
		"lines": [
			{ "speaker": "Darian", "text": "Rumor claims you negotiated with a ghost. Disappointing if true—ghosts rarely sign receipts." },
			{ "speaker": "Tariq", "text": "Rumor also claims you sing sober. Let's call both tales half right." },
		],
		"once_per_visit": true,
		"radius": 172.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_theme_recovery_alden_liora_infirmary",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		"zone_type": "infirmary",
		...
		"lines": [
			{ "speaker": "Brother Alden", "text": "Wrap your own wrist before the third patient. Mercy includes you." },
			{ "speaker": "Brother Alden", "text": "Fatigue is a wound that bleeds schedules worse than steel." },
		],
		"once_per_visit": false,
		"radius": 170.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_theme_training_mira_pell_watch",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "dawn" },
		"zone_type": "watch_post",
		...
		"preferred_visit_themes": ["training"],
		"lines": [
			{ "speaker": "Mira Ashdown", "text": "Call the window before you admire the sunrise. Discipline first, poetry later." },
			{ "speaker": "Mira Ashdown", "text": "Speed means nothing if the first word you say is wrong." },
		],
		"once_per_visit": false,
		"radius": 170.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_theme_somber_hadrien_meris_shrine",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "night" },
		"zone_type": "shrine",
		...
		"lines": [
			{ "speaker": "Ser Hadrien", "text": "Some oaths do not need witnesses—only survivors." },
			{ "speaker": "Ser Hadrien", "text": "Let silence do the honest work tonight. Words can wait." },
		],
		"once_per_visit": true,
		"radius": 172.0,
		"pair_radius": 98.0,
	...
	{
		"id": "social_theme_hopeful_yselle_mira_fire",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "night" },
		"zone_type": "fire",
		...
		"lines": [
			{ "speaker": "Yselle Maris", "text": "You looked the fire in the eye without flinching. That's progress worth keeping quiet about." },
			{ "speaker": "Yselle Maris", "text": "Small warmth, honestly held, beats a brave speech with cold hands." },
		],
		"once_per_visit": false,
		"radius": 170.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_theme_tense_inez_corvin_tree",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "night" },
		"zone_type": "tree_line",
	...
	{
		"id": "social_cluster_theme_training_wall_day",
		"priority": 8,
		"kind": "small_cluster",
		"when": { "time_block": "day" },
		"zone_type": "wall",
		"speaker": "Kaelen",
		"preferred_visit_themes": ["training"],
		"required_units": ["Kaelen", "Celia"],
		"optional_units": ["Sabine Varr", "Pell Rowan"],
		"min_participants": 3,
		"max_participants": 4,
		"ambient_behavior_family": "drill",
		"lines": [
			{ "speaker": "Kaelen", "text": "Same drill as yesterday: boring, loud, and alive. I'll take all three." },
		],
		"once_per_visit": true,
		"radius": 182.0,
		"cluster_radius": 124.0,
	...
	{
		"id": "social_spar_kaelen_celia_wall_day",
		...
		"lines": [
			{ "speaker": "Kaelen", "text": "Wooden blades, full intent. Tap my shoulder guard—point's yours." },
			{ "speaker": "Celia", "text": "No splinters in your pride when I do." },
			{ "speaker": "Kaelen", "text": "Reset. Breathe. Again—like you mean to keep the line tomorrow." },
		],
		"once_per_visit": false,
		"radius": 172.0,
		"pair_radius": 98.0,
	...
	{
		"id": "social_spar_sabine_garrick_wall_tense",
		"preferred_visit_themes": ["tense", "training"],
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		...
		"ambient_behavior_family": "mock_duel",
		"lines": [
			{ "speaker": "Sabine Varr", "text": "Mock duel—your read on my timing, not your feelings about my tone." },
			{ "speaker": "Garrick Vale", "text": "Then you'll be disappointed. I'm fluent in both." },
			{ "speaker": "Sabine Varr", "text": "Hold. Change guard. Again—like the wall depends on honesty." },
		],
		"once_per_visit": false,
		"radius": 174.0,
		"pair_radius": 98.0,
	...
	{
		"id": "social_spar_veska_pell_wall_day",
		"preferred_visit_themes": ["training", "normal"],
		"priority": 7,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		...
		"ambient_behavior_family": "mock_duel",
		"lines": [
			{ "speaker": "Veska Moor", "text": "Shield high—mock strike coming. Count to the beat, not to your pride." },
			{ "speaker": "Pell Rowan", "text": "If I bleed ego, does someone hand me a bandage or a promotion?" },
			{ "speaker": "Veska Moor", "text": "Practice correction. Save heroics for the field." },
		],
		"once_per_visit": false,
		"radius": 170.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_spar_maela_inez_tree_day",
		...
		"ambient_behavior_family": "mock_duel",
		"lines": [
			{ "speaker": "Inez", "text": "Footwork only—no wings, no theatrics. Three passes and you freeze on my mark." },
			{ "speaker": "Maela Thorn", "text": "If I freeze, it's discipline. If I smirk, it's still discipline." },
			{ "speaker": "Inez", "text": "Good. Now quieter on the turn. Mock duels train ears too." },
		],
		"once_per_visit": false,
		"radius": 172.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_drill_formation_wall_day",
		"preferred_visit_themes": ["training", "tense"],
		"priority": 8,
		"kind": "small_cluster",
		"when": { "time_block": "day" },
		"zone_type": "wall",
		"speaker": "Sabine Varr",
		"required_units": ["Sabine Varr", "Kaelen", "Celia"],
		"optional_units": ["Garrick Vale", "Pell Rowan"],
		"min_participants": 3,
		"max_participants": 4,
		"ambient_behavior_family": "formation",
		"lines": [
			{ "speaker": "Sabine Varr", "text": "Spacing check—one breath between shoulders, two between spearheads. Mock holds only; we drill habits, not graves." },
		],
		"once_per_visit": true,
		"radius": 184.0,
	...
	{
		"id": "social_drill_watch_post_ready_chain",
		"preferred_visit_themes": ["tense", "training"],
		"priority": 8,
		"kind": "small_cluster",
		"when": { "time_block": "dawn" },
		"zone_type": "watch_post",
		"speaker": "Garrick Vale",
		"required_units": ["Garrick Vale", "Celia", "Mira Ashdown"],
		"optional_units": ["Pell Rowan"],
		"min_participants": 3,
		"max_participants": 4,
		"ambient_behavior_family": "formation",
		"lines": [
			{ "speaker": "Garrick Vale", "text": "Report chain drill—whisper the window, nod the count, nothing else. Readiness sounds like routine when it's real." },
		],
		"once_per_visit": true,
		"radius": 182.0,
		"cluster_radius": 124.0,
	...
	{
		"id": "social_fireside_hopeful_circle_rare",
		"preferred_visit_themes": ["hopeful", "recovery"],
		"priority": 6,
		"kind": "small_cluster",
		"when": { "time_block": "night" },
		"zone_type": "fire",
		"speaker": "Darian",
		"required_units": ["Darian", "Liora"],
		"optional_units": ["Yselle Maris", "Mira Ashdown", "Brother Alden"],
		"min_participants": 3,
		"max_participants": 4,
		"ambient_behavior_family": "fireside",
		"lines": [
			{ "speaker": "Darian", "text": "Circle stays small tonight. One true sentence each, then let the fire do the preaching." },
		],
		"once_per_visit": true,
		"radius": 184.0,
		"cluster_radius": 126.0,
	...
	{
		"id": "social_fireside_recovery_quiet_breath",
		...
		"zone_type": "fire",
		"speaker": "Brother Alden",
		"required_units": ["Brother Alden", "Liora"],
		"optional_units": ["Tamsin Reed", "Rufus"],
		"min_participants": 3,
		"max_participants": 4,
		"ambient_behavior_family": "morale_fire",
		"lines": [
			{ "speaker": "Brother Alden", "text": "Let the warmth reach your shoulders before you plan the morning. The body keeps score even when bravery won't admit it." },
		],
		"once_per_visit": true,
		"radius": 184.0,
		"cluster_radius": 126.0,
	...
	{
		"id": "social_rhythm_fireside_hopeful_rare",
		"preferred_visit_themes": ["hopeful"],
		"priority": 5,
		"kind": "small_cluster",
		"when": { "time_block": "night" },
		...
		"zone_type": "fire",
		"speaker": "Yselle Maris",
		"required_units": ["Yselle Maris", "Mira Ashdown"],
		"optional_units": ["Darian", "Pell Rowan"],
		"min_participants": 3,
		"max_participants": 4,
		"ambient_behavior_family": "rhythm",
		"lines": [
			{ "speaker": "Yselle Maris", "text": "Soft count of three—clap on one, hush on three. Let the camp hear itself still alive without a speech." },
		],
		"once_per_visit": true,
		"radius": 182.0,
		"cluster_radius": 124.0,
	...
	{
		"id": "social_work_supply_sort_day",
		"preferred_visit_themes": ["normal", "tense", "recovery"],
		"priority": 7,
		"kind": "small_cluster",
		"when": { "time_block": "day" },
		"zone_type": "supply",
		"speaker": "Rufus",
		"required_units": ["Rufus", "Oren Pike"],
		"optional_units": ["Pell Rowan", "Veska Moor"],
		"min_participants": 3,
		"max_participants": 4,
		"ambient_behavior_family": "work_detail",
		"lines": [
			{ "speaker": "Rufus", "text": "Stacks and tallies—no poetry, no missing sacks. If it doesn't fit the list, it doesn't leave the pile." },
		],
		"once_per_visit": true,
		"radius": 182.0,
		"cluster_radius": 124.0,
	...
	{
		"id": "social_work_watch_perimeter_mend",
		"preferred_visit_themes": ["tense", "training"],
		"priority": 7,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		...
		"ambient_behavior_family": "work_detail",
		"lines": [
			{ "speaker": "Kaelen", "text": "Mock cord measured—replace the frayed span before dusk." },
			{ "speaker": "Garrick Vale", "text": "Good. Pride is cheaper than rope, and we aren't buying either." },
		],
		"once_per_visit": true,
		"radius": 172.0,
		"pair_radius": 98.0,
	...
	{
		"id": "social_early_pell_mira_watch_dawn",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "dawn" },
		"zone_type": "watch_post",
		...
		"ambient_behavior_family": "work_detail",
		"lines": [
			{ "speaker": "Pell Rowan", "text": "Call the horizon in plain words. Poetry can wait until we're sure it's empty." },
			{ "speaker": "Mira Ashdown", "text": "North clear. East clear. Words ugly enough for you?" },
		],
		"once_per_visit": false,
		"radius": 170.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_early_sabine_celia_wall_day",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		"zone_type": "wall",
		...
		"ambient_behavior_family": "formation",
		"lines": [
			{ "speaker": "Sabine Varr", "text": "Spacing drill—two steps, same breath. We fix posture before we fix legends." },
			{ "speaker": "Celia", "text": "Legends can mail their complaints to the mortar." },
		],
		"once_per_visit": false,
		"radius": 172.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_early_sorrel_tariq_map_dispute",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		"zone_type": "map_table",
		...
		"relationship_tone": "neutral",
		"lines": [
			{ "speaker": "Sorrel", "text": "This fork isn't wrong—it's just rude." },
			{ "speaker": "Tariq", "text": "Then teach it manners with ink, not boots, until we march." },
		],
		"once_per_visit": false,
		"radius": 170.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_early_oren_rufus_workbench_sort",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		"zone_type": "workbench",
		...
		"ambient_behavior_family": "work_detail",
		"lines": [
			{ "speaker": "Oren Pike", "text": "Sort the brass before the steel—or we'll curse the drawer later." },
			{ "speaker": "Rufus", "text": "Already cursing. Sorting anyway." },
		],
		"once_per_visit": false,
		"radius": 170.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_early_liora_tamsin_infirmary_lists",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		"zone_type": "infirmary",
		...
		"relationship_tone": "warm",
		"lines": [
			{ "speaker": "Liora", "text": "Cross the salve tally before noon—small numbers save loud mistakes." },
			{ "speaker": "Tamsin Reed", "text": "Ink dry, nerves steadier. Same ritual." },
		],
		"once_per_visit": false,
		"radius": 170.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_early_darian_nyx_bench_day",
		"priority": 7,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		"zone_type": "bench",
		...
		"relationship_tone": "neutral",
		"lines": [
			{ "speaker": "Darian", "text": "Sit like you mean to keep the bench. Camp furniture gets ideas." },
			{ "speaker": "Nyx", "text": "If it starts giving orders, I'll file a complaint with gravity." },
		],
		"once_per_visit": false,
		"radius": 168.0,
		"pair_radius": 94.0,
	...
	{
		"id": "social_early_inez_celia_tree_line",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "dawn" },
		"zone_type": "tree_line",
		...
		"ambient_behavior_family": "formation",
		"lines": [
			{ "speaker": "Inez", "text": "Walk the line soft—mock stalk, not real noise." },
			{ "speaker": "Celia", "text": "Boots remembered. Birds forgave me twice." },
		],
		"once_per_visit": false,
		"radius": 170.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_early_alden_hest_cook_support",
		"priority": 7,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		"zone_type": "cook_area",
		...
		"ambient_behavior_family": "work_detail",
		"lines": [
			{ "speaker": "Brother Alden", "text": "Steam before sermon—pass the shallow bowls first." },
			{ "speaker": "Hest \"Sparks\"", "text": "If steam is sacred, my kettle counts as clergy." },
		],
		"once_per_visit": false,
		"radius": 170.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_early_tamsin_liora_fire_warmth",
		"priority": 7,
		"kind": "passing_remark",
		"when": { "time_block": "night" },
		"zone_type": "fire",
		...
		"ambient_behavior_family": "morale_fire",
		"lines": [
			{ "speaker": "Tamsin Reed", "text": "Feet closer. Complaints farther. That's the whole doctrine." },
			{ "speaker": "Liora", "text": "I'll take a doctrine that fits in one breath." },
		],
		"once_per_visit": false,
		"radius": 172.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_pass_darian_yselle_bench_day",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		"zone_type": "bench",
		...
		"relationship_tone": "warm",
		"lines": [
			{ "speaker": "Yselle Maris", "text": "Save the performance for people who need convincing. I'm already seated." },
			{ "speaker": "Yselle Maris", "text": "If you're going to hover, tell me something true about today—small counts." },
		],
		"once_per_visit": false,
		"radius": 170.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_pass_nyx_tariq_tree_night",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "night" },
		"zone_type": "tree_line",
		...
		"relationship_tone": "neutral",
		"lines": [
			{ "speaker": "Nyx", "text": "If your shortcut squeaks, I want it named after whoever invented guilt." },
			{ "speaker": "Tariq", "text": "Then it would have too many names." },
		],
		"once_per_visit": false,
		"radius": 172.0,
		"pair_radius": 98.0,
	...
	{
		"id": "social_pass_branik_alden_supply_day",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		"zone_type": "supply",
		...
		"relationship_tone": "warm",
		"lines": [
			{ "speaker": "Brother Alden", "text": "You stack the sacks like you're building a spell circle—only yours keeps people dry." },
			{ "speaker": "Branik", "text": "A sack that won't fall keeps someone from cursing in the mud." },
		],
		"once_per_visit": false,
		"radius": 170.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_pass_mira_pell_wall_day",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		"zone_type": "wall",
		...
		"relationship_tone": "warm",
		"lines": [
			{ "speaker": "Mira Ashdown", "text": "One breath per step on the parapet—your shoulders will thank you after the third hour." },
			{ "speaker": "Pell Rowan", "text": "Noted. I'll pretend I'm bored on purpose." },
		],
		"once_per_visit": false,
		"radius": 172.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_pass_sabine_veska_watch_dawn",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "dawn" },
		"zone_type": "watch_post",
		...
		"relationship_tone": "neutral",
		"lines": [
			{ "speaker": "Sabine Varr", "text": "Tell me the north ridge is still dull. I could use one dull thing." },
			{ "speaker": "Veska Moor", "text": "Dull and honest—same report as yesterday, with fewer clouds." },
		],
		"once_per_visit": false,
		"radius": 172.0,
		"pair_radius": 98.0,
	...
	{
		"id": "social_pass_corvin_meris_shrine_day",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		"zone_type": "shrine",
		...
		"relationship_tone": "neutral",
		"lines": [
			{ "speaker": "Sister Meris", "text": "If you're here to sharpen regret, file it quietly—people mistake noise for holiness." },
			{ "speaker": "Corvin Ash", "text": "I'll call it sanding. Same dust, less theater." },
		],
		"once_per_visit": false,
		"radius": 172.0,
		"pair_radius": 98.0,
	...
	{
		"id": "social_pass_maela_inez_fire_night",
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "night" },
		"zone_type": "fire",
		...
		"relationship_tone": "warm",
		"lines": [
			{ "speaker": "Inez", "text": "You're hogging the heat again—with your elbows, not your mouth. Progress." },
			{ "speaker": "Maela Thorn", "text": "If I burn quietly, do I get points?" },
		],
		"once_per_visit": false,
		"radius": 170.0,
		"pair_radius": 96.0,
	...
	{
		"id": "social_pass_kaelen_garrick_wall_day",
		"preferred_visit_themes": ["training", "tense"],
		"priority": 8,
		"kind": "passing_remark",
		"when": { "time_block": "day" },
		...
		"ambient_behavior_family": "formation",
		"lines": [
			{ "speaker": "Garrick Vale", "text": "Hold the mock line—I want your rotations boring enough to survive panic." },
			{ "speaker": "Kaelen", "text": "Boring is a compliment from you. I'll carve it on the parapet." },
		],
		"once_per_visit": false,
		"radius": 172.0,
		"pair_radius": 98.0,
