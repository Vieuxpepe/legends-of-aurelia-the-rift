...
const ROUTINES: Dictionary = {
	"Kaelen": [
		...
		{
			"id": "kaelen_wall_day_check",
			"priority": 8,
			"when": { "time_block": "day" },
			"preferred_zones": ["wall", "watch_post", "workbench"],
			"secondary_zones": ["map_table", "fire"],
			"movement_frequency": 0.88,
			"idle_style": "inspect_wall",
		},
		{
			"id": "kaelen_fire_night_reluctant_rest",
			"priority": 5,
			"when": { "time_block": "night" },
			"preferred_zones": ["fire", "watch_post"],
			"secondary_zones": ["bench", "wall"],
	...
	"Darian": [
		...
		{
			"id": "darian_bench_day_morale",
			"priority": 6,
			"when": { "time_block": "day" },
			"preferred_zones": ["bench", "fire", "wagon"],
			"secondary_zones": ["map_table"],
			"movement_frequency": 0.64,
			"idle_style": "neutral",
		},
	],
	"Celia": [
	...
	"Nyx": [
		...
		{
			"id": "nyx_tree_line_night_lurk",
			"priority": 8,
			"when": { "time_block": "night" },
			"preferred_zones": ["tree_line", "wagon", "watch_post"],
			"secondary_zones": ["fire", "bench"],
			"movement_frequency": 0.78,
			"idle_style": "look_out",
		},
	...
	"Mira Ashdown": [
		...
		{
			"id": "mira_fire_night_small_circle",
			"priority": 5,
			"when": { "time_block": "night" },
			"preferred_zones": ["fire", "bench", "tree_line"],
			"secondary_zones": ["watch_post"],
			"movement_frequency": 0.34,
			"idle_style": "look_out",
		},
	],
	"Pell Rowan": [
	...
	"Brother Alden": [
		...
		{
			"id": "alden_fire_night_grounding",
			"priority": 6,
			"when": { "time_block": "night" },
			"preferred_zones": ["fire", "infirmary", "bench"],
			"secondary_zones": ["shrine"],
			"movement_frequency": 0.38,
			"idle_style": "pray_quietly",
		},
	],
	"Garrick Vale": [
	...
	"Sabine Varr": [
		...
		{
			"id": "sabine_wall_day_inspection_chain",
			"priority": 7,
			"when": { "time_block": "day" },
			"preferred_zones": ["wall", "watch_post", "supply"],
			"secondary_zones": ["bench"],
	...
	"Corvin Ash": [
		...
		{
			"id": "corvin_shrine_night_stillness",
			"priority": 7,
			"when": { "time_block": "night" },
			"preferred_zones": ["shrine", "wagon"],
			"secondary_zones": ["bench", "tree_line"],
			"movement_frequency": 0.28,
			"idle_style": "read_notes",
		},
	],
	"Veska Moor": [
	...
	"Maela Thorn": [
		...
		{
			"id": "maela_tree_day_restless_loop",
			"priority": 7,
			"when": { "time_block": "day" },
			"preferred_zones": ["tree_line", "watch_post", "wall"],
			"secondary_zones": ["wagon"],
			"movement_frequency": 0.96,
			"idle_style": "look_out",
		},
		{
			"id": "maela_fire_night_cannot_settle",
			"priority": 5,
			"when": { "time_block": "night" },
			"preferred_zones": ["fire", "bench", "watch_post"],
			"secondary_zones": ["tree_line"],
			"movement_frequency": 0.72,
			"idle_style": "look_out",
		},
